...
void __fastcall TReportForm::FormShow(TObject *Sender)
{
                ...
                if (level > 0)
                {
                        QRLabel8->Caption = "Прирост населения на данный месяц: " + IntToStr(level);
                }
                else if (level < 0)
                {
                        QRLabel8->Caption = "Убыль населения на данный месяц: " + IntToStr(level);
                }
                else
                {
                        QRLabel8->Caption = "На данный месяц нету прироста или убыли населения";
                }
